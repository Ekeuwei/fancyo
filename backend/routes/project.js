...
router.route('/project/new').post(isAuthenticatedUser, authorizeRoles('admin', 'punter', 'super punter'), newProject); 
router.route('/project/contribute').post(isAuthenticatedUser, authorizeRoles('user'), contribute); 

// Ticket Routes
router.route('/ticket/new').post(isAuthenticatedUser, authorizeRoles('admin', 'punter', 'super punter'), newTicket); 
...
router.route('/project/:id')
                    .put(isAuthenticatedUser, authorizeRoles('admin', 'punter', 'super punter'), updateProject)
